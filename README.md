...
writing MCP servers rather than only consuming them.

Before that: an OCR and LLM pipeline that processed 40,000 handwritten archive
pages, and a full-stack PWA built on automation workflows and cascaded LLM calls.
